  ...
  it("should return a 200 status code for a succesful login", done => {
    ...
    chai
      ...
      .end((req, res) => {
        ...
        expect(res.body.data[0]).to.have.own.property(
          "token",
          `${container.token}`
        );
        done();
  ...
  it("should return a 200 status code for a succesful login", done => {
    ...
    chai
      ...
      .end((req, res) => {
        ...
        res.body.should.be.a("object");
        expect(res.body).to.have.own.property(
          "error",
          "Please ensure firstName is a valid string"
        );
        done();
      });
  });
  ...
  it("should return a 400 status code for incomplete paramters", done => {
    chai
      ...
      .end((req, res) => {
        ...
        expect(res.body).to.have.own.property(
          "error",
          "lastName,secondaryEmail are required"
        );
        done();
      });
  });
  ...
  it("should return a 400 status code for incomplete paramters", done => {
    chai
      ...
      .end((req, res) => {
        ...
        expect(res.body).to.have.own.property(
          "error",
          "Please ensure email is a valid email"
        );
        done();
      });
  });
  ...
  it("should return a 400 status code for incomplete paramters", done => {
    chai
      ...
      .end((req, res) => {
        ...
        expect(res.body).to.have.own.property(
          "error",
          "Length of the lastName cannot be less than 3"
        );
        done();
      });
  });
  ...
  it("should return a 400 status code for short password length", done => {
    chai
      ...
      .end((req, res) => {
        ...
        expect(res.body).to.have.own.property(
          "error",
          "password must be alphanumeric and length must be more than 6"
        );
        done();
      });
  });
